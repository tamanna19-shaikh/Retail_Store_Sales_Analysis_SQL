...
CREATE DATABASE IF NOT EXISTS new_database_db;
USE new_database_db;-- Table 1: customers
...
('Rahul Sharma', 'rahul@email.com', 'Mumbai', 'VIP', '2022-01-15'),('Priya Singh',
 'priya@email.com', 'Delhi', 'Premium', '2022-03-20'),
...
('LG 32-inch Monitor', 1, 22999.00, 16000.00, 35);-- Insert orders (across different months)
